...
void Soda::Initialize(KamataEngine::Model* model, KamataEngine::Camera* camera, const KamataEngine::Vector3& pos) {
...
// ワールド座標を取得
KamataEngine::Vector3 Soda::GetWorldPosition() {
...
void Soda::Draw() { model_->Draw(worldtransfrom_, *camera_); }
